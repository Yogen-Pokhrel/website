...
for (i in fullGame.pokemon) {
  ...
  {
      console.log("Pokemon ID:"+fullGame.pokemon[i].id);
      console.log("Pokemon Num:"+fullGame.pokemon[i].num);
      console.log("Pokemon Name:"+fullGame.pokemon[i].name);
      console.log("Pokemon Image:"+fullGame.pokemon[i].img);
      console.log("Pokemon type:"+fullGame.pokemon[i].type);
      console.log("Pokemon height:"+fullGame.pokemon[i].height);
      console.log("Pokemon weight:"+fullGame.pokemon[i].weight);
      console.log("Pokemon candy:"+fullGame.pokemon[i].candy);
      console.log("Pokemon egg:"+fullGame.pokemon[i].egg);
      console.log("Pokemon spawn_chance:"+fullGame.pokemon[i].spawn_chance);
      console.log("Pokemon multipliers:"+fullGame.pokemon[i].multipliers);
      console.log("Pokemon weaknesses:"+fullGame.pokemon[i].weaknesses);
         for (j in fullGame.pokemon[i].prev_evolution) {
          console.log("pokemon prev_evolution \n")
         console.log("Pokemon num"+fullGame.pokemon[i].prev_evolution[j].num);
        console.log("Pokemon Name"+fullGame.pokemon[i].prev_evolution[j].name);
        }

      for (j in fullGame.pokemon[i].next_evolution) {
          console.log("pokemon next_evolution \n")
         console.log("Pokemon num"+fullGame.pokemon[i].next_evolution[j].num);
        console.log("Pokemon Name"+fullGame.pokemon[i].next_evolution[j].name);
        }
         flag=0;
           break;
    ...
    if(flag==1)
    console.log("wrong pokemon name please enter correct pokemonName");
}



function findnextEvolutionPokemonName(n)
{
  var i,j,flag=0;
  ...
  { 
     for (j in fullGame.pokemon[i].next_evolution) {
          ...
          {
          console.log("Pokemon Name whose next_evolution was "+n+" is::"+fullGame.pokemon[i].name)
          flag++;
          }
      }
  }
  if(flag==0)
  {
     console.log("sorry no pokemon have given pokemon name as next evolution pokemon")
  }
 }
...
function findWeakness()
{
  ...
  { 
     for (j in fullGame.pokemon[i].weaknesses) {
          ...
          {
          console.log("Pokemon Name whose with weakness "+n+" is::"+fullGame.pokemon[i].name)
          flag++;
          }
      }
  }
  if(flag==0)
  {
     console.log("sorry no pokemon have given weakness ")
  }
...
console.log("<<<<<<-----------1)  finding pokemon details using pokemon name----------->>>>>>");
var n=prompt("enter the pokemon name","");
PokemonSearch(n);
console.log("<<<<<<----------2)  finding out which all pokemon have given name in their “next_evolution------------>>>>>>>"); 
var o=prompt("enter the pokemon name to find out which all pokemon have that name in their “next_evolution” field","");
findnextEvolutionPokemonName(o);
console.log("<<<<<<------------3) finding the pokemon which have given weakness---------->>>>>>>>");
findWeakness();