...
var i;
var flag=true;
for(i in pokemongame.pokemon)
{
  if(pokemongame.pokemon[i].name==name)
  {
    flag=false;
    document.write("id is:"+pokemongame.pokemon[i].id);
    document.write("<br>Pokemon ID:"+pokemongame.pokemon[i].id);
      document.write("<br>Pokemon Num:"+pokemongame.pokemon[i].num);
      document.write("<br>Pokemon Name:"+pokemongame.pokemon[i].name);
      document.write("<br>Pokemon Image:"+pokemongame.pokemon[i].img);
      document.write("<br>Pokemon type:"+pokemongame.pokemon[i].type);
      document.write("<br>Pokemon height:"+pokemongame.pokemon[i].height);
      document.write("<br>Pokemon weight:"+pokemongame.pokemon[i].weight);
     document.write("<br>Pokemon candy:"+pokemongame.pokemon[i].candy);
      document.write("<br>Pokemon egg:"+pokemongame.pokemon[i].egg);
      document.write("<br>Pokemon spawn_chance:"+pokemongame.pokemon[i].spawn_chance);
      document.write("<br>Pokemon multipliers:"+pokemongame.pokemon[i].multipliers);
      document.write("<br>Pokemon weaknesses:"+pokemongame.pokemon[i].weaknesses);
  }

}
if(flag)
{
  var name=prompt("The name is not valid \n Enter the name Again");
...
function evolution(name)
{
var i,j;
var flag=true;
for(i in pokemongame.pokemon)
{
  for(j in pokemongame.pokemon[i].next_evolution)
  {
  if(pokemongame.pokemon[i].next_evolution[j].name==name)
  {
    flag=false;
    document.write("id is:"+pokemongame.pokemon[i].id);
    document.write("<br>Pokemon ID:"+pokemongame.pokemon[i].id);
      document.write("<br>Pokemon Num:"+pokemongmonitoame.pokemon[i].num);
      document.write("<br>Pokemon Name:"+pokemongame.pokemon[i].name);
      document.write("<br>Pokemon Image:"+pokemongame.pokemon[i].img);
      document.write("<br>Pokemon type:"+pokemongame.pokemon[i].type);
      document.write("<br>Pokemon height:"+pokemongame.pokemon[i].height);
...
if(flag)
{
  var name=prompt("Name doesnot match Try other name");
}

}

var name=prompt("Enter the name to get the information");
evolution(name);
